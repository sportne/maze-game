...
1. [WEB-01: Align the TeaVM toolchain](teavm-01-toolchain-alignment.md)
2. [WEB-02: Introduce portable runtime services](teavm-02-portable-runtime-services.md)
3. [WEB-03: Isolate desktop filesystem and screenshot behavior](teavm-03-desktop-adapters.md)
4. [WEB-04: Add the JavaScript browser module](teavm-04-javascript-module.md)
5. [WEB-05: Make layout and input browser-ready](teavm-05-browser-input-layout.md)
6. [WEB-06: Harden browser audio, lifecycle, and persistence](teavm-06-browser-runtime-behavior.md)
7. [WEB-07: Add automated browser smoke coverage](teavm-07-browser-smoke-tests.md)
8. [WEB-08: Produce a release-quality static site](teavm-08-production-webapp.md)
