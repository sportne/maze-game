...
Maze Game now includes five authored levels, persistent unlock progression and per-level
best results, finite/infinite Wall and Slow Floor inventory, responsive click/drag building, and
Scout: a visually distinct deterministic solver whose search must be learned by observation.
...
Floor building system. Authored supply, transactional maze inventory, shared solver timing,
