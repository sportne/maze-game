...
| Edge 151 touch emulation | Full flow passed | Used real touch events, not mouse clicks |
...
The full flow covers the menu, level selection, audio loading and gesture resume, maze editing,
completion, local persistence, reload, resize guidance, runtime/asset requests, and errors. The
